...
class qualificationTechnique extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('situationAppel',new situationAppelType("qualificationTechnique"))
        ;
    ...
    {
        return 'ficheProjetFormAppelQualificationTechnique';
    }
} 